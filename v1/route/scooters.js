...
router.get(
  ...
  (req, res, next) => authModel.validTokenKey(req, res, next),
  (req, res) =>
    scootersModel.getAllScootersCity(res, req.params.owner_id, req.path)
);

router.put(
  "/status", // Get status form a specific scooter
  (req, res, next) => authModel.validTokenKey(req, res, next),
  (req, res) => scootersModel.editStatusScooter(res, req.body, req.path)
);

router.put(
  "/coordinates", // Get coordinates from a specific scooter
  (req, res, next) => authModel.validTokenKey(req, res, next),
  (req, res) => scootersModel.editCoordinatesScooter(res, req.body, req.path)
);
...
router.post(
  "/stop", // Stop rent a scooter
  (req, res, next) => authModel.validTokenKey(req, res, next),
  (req, res) =>
    scootersModel.stopScooter(
      res,
      req.body.scooter_id,
      req.body.user_id,
      req.path
